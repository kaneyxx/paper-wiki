...
| `/paper-wiki:wiki-graph`        | Query the v0.4.x typed-entity knowledge graph (papers citing X, concepts in topic Y, collaborators of person Z). Auto-rebuilds `<vault>/Wiki/.graph/` cache when stale. |
