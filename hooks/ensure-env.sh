...
EXPECTED_TAG="# paperwiki shim — v0.3.43 (shared venv + self-bootstrap + PYTHONPATH fallback)."
...
EXPECTED_HELPER_TAG="# paperwiki bash-helpers — v0.3.43 (PATH guard + CLAUDE_PLUGIN_ROOT resolver)."
